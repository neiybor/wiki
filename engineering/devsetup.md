...
1. Get access to your neighbor gmail account.
...
1. Walk through your team's project board with an admin
...
1. Setup your AWS account
	...
	1. Admin: Make the user an access key
		1. Send them the following:
	   
```text
      You will need the following to setup the AWS CLI while the setup-dev script runs
...
1. Populate the admin search index for your local environment
  ...
  1. Run `rake api:index_users` in the `rails-api` directory
